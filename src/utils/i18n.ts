...
export const translations: Record<Language, Translations> = {
  fr: {
    ...
    advancedTitle: "Apprentissage technique avancé",
    advancedQuestion: "Cybersécurité, pentest éthique et programmation système",
    advancedDesc: "Environnement approfondi : rétro-ingénierie, audits de sécurité, scripting réseau, analyse d'exploits en laboratoire et programmation bas niveau.",
  ...
  en: {
    ...
    advancedTitle: "Advanced Technical Learning",
    advancedQuestion: "Cybersecurity, ethical pentest, and system programming",
    advancedDesc: "In-depth environment: reverse engineering, security audits, network scripting, exploit mechanics in labs, and low-level coding.",
  ...
  es: {
    ...
    advancedTitle: "Aprendizaje técnico avanzado",
    advancedQuestion: "Ciberseguridad, pentesting ético y programación de sistemas",
    advancedDesc: "Entorno profundo: ingeniería inversa, auditorías de seguridad, scripting de redes, análisis de exploits en laboratorio y código de bajo nivel.",
